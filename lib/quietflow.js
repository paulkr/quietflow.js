...
$.fn.quietflow = function(attributes){
	...
	var theme = "starfield";
	var z_Index;
	attributes.z_Index != undefined ? z_Index = attributes.z_Index : z_Index = -1000;
	...
	if (attributes != undefined){
		...
		if (attributes.theme == "squareFlash"){
			...
			if (attributes.lineColor != undefined) lineColor = attributes.lineColor;
	...
	// sebastian and priscilla make the math and do the shooting curcles.
